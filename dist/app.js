(() => {
  ...
  function openInfo(type) { const english=localStorage.getItem("gmach-language")==="en"; const source=english?INFO_CONTENT_EN:INFO_CONTENT; $("#info-dialog-content").innerHTML = source[type] || source.safety; openDialog($("#info-dialog")); }
