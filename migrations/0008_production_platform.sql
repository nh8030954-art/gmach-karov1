...
ALTER TABLE loan_requests ADD COLUMN quantity INTEGER NOT NULL DEFAULT 1;
...
ALTER TABLE reviews ADD COLUMN item_id TEXT REFERENCES items(id) ON DELETE SET NULL;
...
CREATE INDEX waitlist_item_idx ON waitlist_entries(item_id,status,created_at);
