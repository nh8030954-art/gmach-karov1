...
const EXTRA_CATEGORY_CATALOG=[["cat-baby",null,"תינוקות וילדים","Baby & Kids","👶",["תינוק","ילדים","לידה"]],["cat-baby-strollers","cat-baby","עגלות ומנשאים","Strollers & Carriers","",["עגלה","טיולון","מנשא"]],["cat-baby-feeding","cat-baby","האכלה והנקה","Feeding & Nursing","",["משאבת חלב","כיסא אוכל","בקבוקים"]],["cat-baby-sleep","cat-baby","שינה ועריסות","Sleep & Cribs","",["עריסה","לול","מיטה"]],["cat-baby-safety","cat-baby","בטיחות לתינוק","Baby Safety","",["שער בטיחות","מוניטור"]],["cat-events",null,"אירועים ושמחות","Events & Celebrations","🎉",["אירוע","שמחה","חתונה","בר מצווה"]],["cat-events-tables","cat-events","שולחנות וכיסאות","Tables & Chairs","",["כיסא","שולחן","ישיבה"]],["cat-events-decor","cat-events","עיצוב וקישוט","Decorations","",["קישוט","תפאורה","חופה"]],["cat-events-sound","cat-events","הגברה ותאורה","Sound & Lighting","",["רמקול","מיקרופון","תאורה"]],["cat-events-serving","cat-events","הגשה ואירוח","Serving & Hosting","",["מיחם","פלטה","כלי הגשה"]],["cat-medical",null,"ציוד רפואי ושיקומי","Medical & Rehabilitation","🩺",["רפואי","שיקום","בריאות"]],["cat-medical-mobility","cat-medical","ניידות והליכה","Mobility","",["כיסא גלגלים","הליכון","קביים"]],["cat-medical-home","cat-medical","ציוד רפואי לבית","Home Medical","",["מיטה רפואית","מד לחץ דם","סטורציה"]],["cat-medical-recovery","cat-medical","החלמה ושיקום","Recovery","",["שיקום","כרית","סד"]],["cat-tools",null,"כלי עבודה ותחזוקה","Tools & Maintenance","🧰",["כלים","עבודה","תיקון"]],["cat-tools-power","cat-tools","כלים חשמליים","Power Tools","",["מקדחה","מברגה","משחזת"]],["cat-tools-hand","cat-tools","כלי יד","Hand Tools","",["פטיש","מברג","פלייר"]],["cat-tools-ladders","cat-tools","סולמות ועבודה בגובה","Ladders","",["סולם","גובה"]],["cat-home",null,"בית ומשק בית","Home & Household","🏠",["בית","משק"]],["cat-home-cleaning","cat-home","ניקיון","Cleaning","",["שואב","קיטור","ניקוי"]],["cat-home-appliances","cat-home","מכשירי חשמל","Appliances","",["מכשיר","חשמל","מיקסר"]],["cat-home-furniture","cat-home","ריהוט זמני","Temporary Furniture","",["מזרן","מיטה","שולחן"]],["cat-travel",null,"טיולים ושטח","Travel & Outdoors","🏕️",["טיול","קמפינג","שטח"]],["cat-travel-camping","cat-travel","קמפינג ולינה","Camping","",["אוהל","שק שינה","מזרן שטח"]],["cat-travel-hiking","cat-travel","טיולים והליכה","Hiking","",["תרמיל","מקלות הליכה"]],["cat-travel-cooking","cat-travel","בישול שטח","Outdoor Cooking","",["גזיה","צידנית","פקל קפה"]],["cat-electronics",null,"אלקטרוניקה ומחשוב","Electronics & Computing","💻",["מחשב","אלקטרוניקה"]],["cat-electronics-computers","cat-electronics","מחשבים ואביזרים","Computers","",["מחשב נייד","מסך","מקלדת"]],["cat-electronics-projectors","cat-electronics","מקרנים ומסכים","Projectors & Screens","",["מקרן","מסך הקרנה"]],["cat-electronics-charging","cat-electronics","טעינה וחשמל נייד","Charging & Power","",["מטען","סוללה","גנרטור"]],["cat-books",null,"ספרים ולימוד","Books & Learning","📚",["ספר","לימוד","קורס"]],["cat-books-religious","cat-books","ספרי קודש","Religious Books","",["סידור","חומש","גמרא"]],["cat-books-study","cat-books","לימודים ומבחנים","Study & Exams","",["ספר לימוד","מבחן","פסיכומטרי"]],["cat-sports",null,"ספורט ופנאי","Sports & Leisure","⚽",["ספורט","פנאי"]],["cat-sports-balls","cat-sports","משחקי כדור","Ball Sports","",["כדור","שער"]],["cat-sports-fitness","cat-sports","כושר ואימון","Fitness","",["משקולות","מזרן יוגה"]],["cat-sports-water","cat-sports","ים ובריכה","Water Sports","",["גלשן","שנורקל","מצוף"]],["cat-clothing",null,"ביגוד ואביזרים","Clothing & Accessories","👔",["בגדים","לבוש"]],["cat-clothing-formal","cat-clothing","בגדי אירועים","Formal Wear","",["חליפה","שמלה","עניבה"]],["cat-clothing-winter","cat-clothing","חורף וגשם","Winter & Rain","",["מעיל","מגפיים","מטריה"]],["cat-mobility",null,"תחבורה וניידות","Transport & Mobility","🚲",["תחבורה","ניידות"]],["cat-mobility-bikes","cat-mobility","אופניים ואביזרים","Bicycles","",["אופניים","קסדה"]],["cat-mobility-car","cat-mobility","אביזרי רכב","Car Accessories","",["כבלים","בוסטר","גגון"]],["cat-moving",null,"מעבר דירה והובלה","Moving & Transport","📦",["מעבר","הובלה","אריזה"]],["cat-moving-boxes","cat-moving","ארגזים ואריזה","Boxes & Packing","",["ארגז","קרטון"]],["cat-moving-carts","cat-moving","עגלות שינוע","Moving Carts","",["עגלה","שינוע"]],["cat-garden",null,"גינה וחוץ","Garden & Outdoor","🌿",["גינה","חצר"]],["cat-garden-tools","cat-garden","כלי גינון","Garden Tools","",["מכסחת","מזמרה","את"]],["cat-garden-seating","cat-garden","ריהוט חוץ","Outdoor Furniture","",["כיסא גינה","שולחן גינה"]],["cat-kitchen",null,"מטבח ואפייה","Kitchen & Baking","🍳",["מטבח","אפייה","בישול"]],["cat-kitchen-baking","cat-kitchen","אפייה","Baking","",["תבנית","מיקסר","עוגה"]],["cat-kitchen-large","cat-kitchen","ציוד בישול גדול","Large Cooking Equipment","",["סיר","פלטה","מיחם"]],["cat-music",null,"מוזיקה וכלי נגינה","Music & Instruments","🎵",["מוזיקה","כלי נגינה"]],["cat-music-instruments","cat-music","כלי נגינה","Instruments","",["גיטרה","קלידים","כינור"]],["cat-music-audio","cat-music","ציוד אודיו","Audio Equipment","",["מיקרופון","מיקסר","רמקול"]],["cat-photo",null,"צילום ויצירה","Photography & Creative","📷",["צילום","מצלמה","יצירה"]],["cat-photo-camera","cat-photo","מצלמות ואביזרים","Cameras","",["מצלמה","חצובה","עדשה"]],["cat-crafts","cat-photo","יצירה ומלאכה","Arts & Crafts","",["יצירה","תפירה","סריגה"]],["cat-office",null,"משרד וקהילה","Office & Community","🗂️",["משרד","קהילה"]],["cat-office-equipment","cat-office","ציוד משרדי","Office Equipment","",["מדפסת","למינציה","גריסה"]],["cat-community","cat-office","ציוד קהילתי","Community Equipment","",["בית כנסת","קהילה","שיעור"]],["cat-accessibility",null,"נגישות ועזר","Accessibility & Assistive","♿",["נגישות","עזר"]],["cat-accessibility-hearing","cat-accessibility","שמיעה ותקשורת","Hearing & Communication","",["מגבר","שמיעה"]],["cat-accessibility-vision","cat-accessibility","ראייה וקריאה","Vision & Reading","",["זכוכית מגדלת","קריאה"]],["cat-emergency",null,"חירום והפסקות חשמל","Emergency & Power Outage","🆘",["חירום","הפסקת חשמל"]],["cat-emergency-light","cat-emergency","תאורת חירום","Emergency Lighting","",["פנס","תאורה"]],["cat-emergency-power","cat-emergency","גיבוי חשמל","Backup Power","",["סוללה","תחנת כוח"]],["cat-shiva",null,"שבעה ואבל","Shiva & Mourning","🕯️",["שבעה","אבל"]],["cat-shiva-seating","cat-shiva","כיסאות וציוד לשבעה","Shiva Equipment","",["כיסא","מזרן","מחיצה"]],["cat-simcha",null,"ציוד דתי וטקסי","Religious & Ceremony","✡️",["דת","טקס"]],["cat-simcha-tallit","cat-simcha","טלית ותפילין זמניים","Tallit & Tefillin","",["טלית","תפילין"]],["cat-simcha-sukkah","cat-simcha","סוכה וחגים","Sukkah & Holidays","",["סוכה","לולב","חג"]]];
...
async function ensureFinalSchema(env){
  ...
  schemaPromise=(async()=>{
    ...
    for(const [id,parentId,nameHe,nameEn,icon,synonyms] of EXTRA_CATEGORY_CATALOG){
      await env.DB.prepare("INSERT OR IGNORE INTO categories(id,parent_id,name_he,name_en,icon,synonyms_json,status,sort_order) VALUES(?,?,?,?,?,?,'active',500)").bind(id,parentId,nameHe,nameEn,icon,JSON.stringify(synonyms||[])).run();
    }
    return true;
